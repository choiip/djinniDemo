...
- (id)initWithCpp:(const std::shared_ptr<::hwsdk::HelloWorld>&)cppRef;

@end

@implementation HWHelloWorld {
    ::djinni::CppProxyCache::Handle<std::shared_ptr<::hwsdk::HelloWorld>> _cppRefHandle;
}
...
+ (nullable HWHelloWorld *)create {
    try {
        auto objcpp_result_ = ::hwsdk::HelloWorld::create();
        return ::djinni_generated::HelloWorld::fromCpp(objcpp_result_);
    } DJINNI_TRANSLATE_EXCEPTIONS()
}

- (nonnull NSString *)getHelloWorld:(nonnull NSString *)message {
    try {
        auto objcpp_result_ = _cppRefHandle.get()->get_hello_world(::djinni::String::toCpp(message));
