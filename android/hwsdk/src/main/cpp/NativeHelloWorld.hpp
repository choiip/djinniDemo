...
class NativeHelloWorld final : ::djinni::JniInterface<::hwsdk::HelloWorld, NativeHelloWorld> {
public:
    using CppType = std::shared_ptr<::hwsdk::HelloWorld>;
    using CppOptType = std::shared_ptr<::hwsdk::HelloWorld>;
...
private:
    ...
    friend ::djinni::JniInterface<::hwsdk::HelloWorld, NativeHelloWorld>;
